    ...
    <div className="modal-backdrop" role="presentation" onMouseDown={onClose}>
      ...
      >
        ...
        <div className="help-comment-note">
          ...
          <p>Select text, or place the cursor in a paragraph, before opening a comment. Its anchor follows nearby edits and mirrors to the pull request when available.</p>
        </div>
      </section>
    </div>
  )
