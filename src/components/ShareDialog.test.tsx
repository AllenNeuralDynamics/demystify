...
describe('ShareDialog', () => {
  it('presents maintainer, suggestion, and viewer modes with safe links', async () => {
    ...
    expect(container.textContent).toContain('propose Source or Visual edits')
    expect(container.textContent).toContain('do not change canonical source until a maintainer accepts one')
